<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            Autókölcsönző
            <img src="./images/icon.png" height="30" alt="autokolcsonzo logo">
        </a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                if ($_SESSION['login']) {
                    echo '<li class="nav-item">
                        <a class="nav-link' . ($menu == 'autokolcsonzesUser' ? ' active' : '') . '" aria-current="page" href="index.php?menu=autokolcsonzesUser">Autókölcsönzés</a>
                      </li>
                        <li class = "nav-item">
                    ...
                    echo '<li class = "nav-item">
                        <a class = "nav-link' . ($menu == 'autokolcsonzesGuest' ? ' active' : '') . '" aria-current = "page" href = "index.php?menu=autokolcsonzesGuest">Autókölcsönzés</a>
                    </li>
                    <li class = "nav-item">
